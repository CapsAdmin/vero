...
export const Icon = (props: { inline?: boolean; type: keyof BaseTheme["icons"]; style?: CSSProperties; size?: ThemeSizes; color?: ThemeColor }) => {
	const theme = useTheme()
